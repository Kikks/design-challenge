...
const isValidLinkedInUrl = (url: string) => {
	return /^https?:\/\/(?:www\.)?linkedin\.com\/(?:in|pub|profile|company)\/[\w-]+\/?$/.test(
		url
	);
};
...
const settingsTabs = [
	{ label: "Your Profile", value: "profile", isDisabled: true },
	{ label: "Company Info", value: "company-info", isDisabled: false },
	{ label: "Manage Seats", value: "manage-seats", isDisabled: true },
	{ label: "Do not Contact", value: "do-not-contact", isDisabled: true },
	{ label: "Integrations", value: "integrations", isDisabled: true }
];
	...
	const onDrop = useCallback((acceptedFiles: File[]) => {
		if (acceptedFiles?.[0]) {
			if (!acceptedFiles[0].type.includes("image")) {
				toast({
					description: "File should be an image",
					variant: "destructive",
					duration: 5000
				});
